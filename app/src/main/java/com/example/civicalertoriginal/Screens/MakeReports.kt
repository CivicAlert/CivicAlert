...
fun MakeReports(navController: NavController) {
    ...
    Column(
        ...
        Text(text = "Make A Report", modifier = Modifier.fillMaxWidth(),
            fontSize = 45.sp,
            color = Color.Green)
      ...
      ExposedDropdownMenuBox()
        ...
        val report = hashMapOf("Report Description" to description, "Report picture" to picture,
            "Report location" to location)
        BottomButtons(name = "SUBMIT REPORT") {myRef.push().setValue(report)}
         }
